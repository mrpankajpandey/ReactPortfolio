          ...
          <div className="flex flex-col md:flex-row">
            <div className="md:w-1/2 mt-12 md:mt-24 space-y-2 order-2 md:order-1">
              ...
              <p className="text-sm md:text-md text-justify">
                From Lucknow Uttar Pradesh, India. I am a technology enthusiast,
                competent, well-focused full stack developer👨‍💻. I am passionate
                about building fully functional web, applications and Android
                applications. I am skilled in HTML, CSS, Javascript, ReactJS,
                git, Android with java , python django, Flask I am good in data
                structure and algorithms. I am also an open-source enthusiast. I
                learned a lot from the open-source community and I love how
                collaboration and knowledge sharing happened through
                open-source.
              </p>
              <br />
              {/* Socila media icons  */}
