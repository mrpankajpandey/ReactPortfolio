    ...
    <>
      ...
      >
        ...
        <div className="grid bg-[#1c1b23] gap-6 lg:col-span-3 p-5">
          <div className="text-xl font-medium mt-2 text-zinc-200">
            More projects
          </div>
          <div className="grid grid-cols-1 gap-4 rounded-lg">
            <a target="_blank" href="https://mrpankajpandey-ai-course.vercel.app">
              <div className="flex items-center gap-1 text-[#8b8a91] rounded-lg">
                ...
                <div className="flex flex-1 xl flex-col px-4 py-2">
                  ...
                  <div className="flex font-bold text-xm">
                  Next.js, Clerk, Firebase Storage, Neon
                  PostgreSQ
                  </div>
                  <div className="flex text-xs">
                    Developed an AI-powered course platform with user
                    authentication, admin dashboard, and media management using
                    Firebase Storage and Neon PostgreSQL.
                  </div>
                </div>
                <IoIosArrowForward className="text-2xl" />
                {/* github visit icon */}
                <a href="http://https://github.com/mrpankajpandey/ai-course-generator" target="_blank" rel="noopener noreferrer"></a>
              </div>
            </a>
            <a target="_blank" href="#">
              <div className="flex items-center gap-1 text-[#8b8a91] rounded-lg">
                ...
                <div className="flex flex-1 xl flex-col px-4 py-2">
                  ...
                  <div className="flex text-xm font-bold">ReactJs, ExpressJs, NodeJs</div>
                  <div className="flex text-xs">
                    It's a docs converter app Docs to Pdf-{" "}
                  </div>
                </div>
                <IoIosArrowForward className="text-2xl" />
                {/* github visit icon */}
            ...
            <a target="_blank" href="#">
              <div className="flex items-center gap-1 text-[#8b8a91] rounded-lg">
                ...
                <IoIosArrowForward className="text-2xl" />
                {/* github visit icon */}
                <a href="http://https://github.com/mrpankajpandey/ReactPortfolio" target="_blank" rel="noopener noreferrer"></a>
              </div>
            </a>
          </div>
        </div>
